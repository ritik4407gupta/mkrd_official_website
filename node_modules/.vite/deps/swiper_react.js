  ...
  Object.keys(plainObj).forEach((key) => {
    ...
    if (allowedParams.indexOf(key) >= 0) {
      if (isObject(value)) {
        params[key] = {};
        passedParams[key] = {};
        extend2(params[key], value);
        extend2(passedParams[key], value);
      } else {
        params[key] = value;
...
var Swiper2 = (0, import_react.forwardRef)(function Swiper3(propsArg, externalElRef) {
  ...
  const { params: swiperParams, passedParams, rest: restProps, events: events2 } = getParams(rest);
  ...
  const initSwiper = () => {
    ...
    if (instance.virtual && ((_a = instance.params.virtual) == null ? void 0 : _a.enabled)) {
      ...
      extend2(instance.params.virtual, extendWith);
      if (instance.originalParams.virtual)
        extend2(instance.originalParams.virtual, extendWith);
    }
  };
...
var SwiperSlide = (0, import_react.forwardRef)(function SwiperSlide2(props, externalRef) {
  ...
  return import_react.default.createElement(
    TagComponent,
    { ref: slideElRef, className: uniqueClasses(`${slideClasses}${className ? ` ${className}` : ""}`), "data-swiper-slide-index": virtualIndex, onLoad: onLoad2, ...rest },

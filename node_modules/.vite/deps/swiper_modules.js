...
var Virtual = ({ swiper, extendParams, on, emit }) => {
  ...
  let tempDOM;
  const getTempDOM = () => tempDOM ?? (tempDOM = document.createElement("div"));
  ...
  on("beforeInit", () => {
    ...
    const passedSlidesUndefined = !passedVirtual || typeof passedVirtual !== "object" || passedVirtual.slides === void 0;
...
var Mousewheel = ({ swiper, extendParams, on, emit }) => {
  ...
  function normalize(e) {
    ...
    if (ev.wheelDelta !== void 0) {
      sY = -ev.wheelDelta / 120;
    }
    if (ev.wheelDeltaY !== void 0) {
      sY = -ev.wheelDeltaY / 120;
    }
    if (ev.wheelDeltaX !== void 0) {
  ...
  function handle(event) {
    ...
    if (!swiper.params.freeMode || !(freeModeParams == null ? void 0 : freeModeParams.enabled)) {
      const newEvent = {
        time: now(),
      ...
      if (!ignoreWheelEvents) {
        ...
        if (freeModeParams == null ? void 0 : freeModeParams.sticky) {
        ...
        if (swiper.params.autoplay && (autoplayParams == null ? void 0 : autoplayParams.disableOnInteraction)) {
...
var Scrollbar = ({ swiper, extendParams, on, emit }) => {
  ...
  function getPointerPosition(e) {
    var _a, _b, _c, _d;
    if (swiper.isHorizontal()) {
      return e.clientX ?? ((_b = (_a = e.touches) == null ? void 0 : _a[0]) == null ? void 0 : _b.clientX) ?? 0;
    }
    return e.clientY ?? ((_d = (_c = e.touches) == null ? void 0 : _c[0]) == null ? void 0 : _d.clientY) ?? 0;
  }
...
var Zoom = ({ swiper, extendParams, on, emit }) => {
  ...
  function getMaxRatio() {
    var _a;
    const params = getParams();
    const attr = (_a = gesture.imageWrapEl) == null ? void 0 : _a.getAttribute("data-swiper-zoom");
  ...
  function onGestureStart(e) {
    ...
    if (!gesture.slideEl) {
      const target = e.target;
      gesture.slideEl = (target == null ? void 0 : target.closest(`.${swiper.params.slideClass}, swiper-slide`)) ?? void 0;
      if (!gesture.slideEl)
        gesture.slideEl = swiper.slides[swiper.activeIndex];
      let imageEl = ((_a = gesture.slideEl) == null ? void 0 : _a.querySelector(`.${params.containerClass}`)) ?? null;
      if (imageEl) {
        imageEl = imageEl.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0] ?? null;
      }
      gesture.imageEl = imageEl ?? void 0;
      if (imageEl) {
        gesture.imageWrapEl = elementParents(imageEl, `.${params.containerClass}`)[0] ?? void 0;
      } else {
  ...
  function preventTouchMove() {
    if (allowTouchMoveTimeout !== void 0)
  ...
  function zoomIn(e) {
    ...
    if (!gesture.slideEl) {
      if (e && typeof e !== "number" && "target" in e && e.target) {
        gesture.slideEl = e.target.closest(`.${swiper.params.slideClass}, swiper-slide`) ?? void 0;
      }
      if (!gesture.slideEl) {
        const virtual = swiper.params.virtual;
        if (virtual && virtual.enabled && swiper.virtual) {
          gesture.slideEl = elementChildren(swiper.slidesEl, `.${swiper.params.slideActiveClass}`)[0] ?? void 0;
        } else {
          gesture.slideEl = swiper.slides[swiper.activeIndex];
        }
      }
  ...
  function getListeners() {
    ...
    const activeListenerWithCapture = swiper.params.passiveListeners ? { passive: false, capture: true } : true;
...
var LinearSpline = class {
  constructor(x, y) {
    ...
    __publicField(this, "binarySearch");
    let maxIndex;
    let minIndex;
    let guess;
...
var A11y = ({ swiper, extendParams, on }) => {
  ...
  function onEnterOrSpaceKey(e) {
    ...
    if (swiper.pagination && swiper.pagination.el && (targetEl === swiper.pagination.el || swiper.pagination.el.contains(targetEl))) {
      if (!targetEl.matches(classesToSelector(paginationParams == null ? void 0 : paginationParams.bulletClass)))
        return;
    }
    ...
    if (swiper.pagination && targetEl.matches(classesToSelector(paginationParams == null ? void 0 : paginationParams.bulletClass))) {
      targetEl.click();
    }
  }
  ...
  function hasClickablePagination() {
    const paginationParams = swiper.params.pagination;
    return hasPagination() && !!(paginationParams == null ? void 0 : paginationParams.clickable);
  }
  ...
  const handleFocus = (e) => {
    ...
    const isVirtual = isVirtualEnabled2(swiper);
  ...
  const init = () => {
    ...
    if (params.wrapperLiveRegion) {
      const autoplayParams = swiper.params.autoplay;
      const live = swiper.params.autoplay && (autoplayParams == null ? void 0 : autoplayParams.enabled) ? "off" : "polite";
...
var History = ({ swiper, extendParams, on }) => {
  ...
  let paths = { key: void 0, value: void 0 };
  function getParams() {
  ...
  const setHistory = (key, index) => {
    ...
    const isVirtualEnabled4 = !!((_a = swiper.params.virtual) == null ? void 0 : _a.enabled);
    const slide = swiper.virtual && isVirtualEnabled4 ? swiper.slidesEl.querySelector(`[data-swiper-slide-index="${index}"]`) : swiper.slides[index];
    if (!slide)
      return;
...
var HashNavigation = ({ swiper, extendParams, emit, on }) => {
  ...
  const onHashChange = () => {
    ...
    const activeSlideEl = isVirtualEnabled3(swiper) ? swiper.slidesEl.querySelector(`[data-swiper-slide-index="${swiper.activeIndex}"]`) : swiper.slides[swiper.activeIndex];
...
var Autoplay = ({ swiper, extendParams, on, emit, params }) => {
  ...
  const getSlideDelay = () => {
    var _a;
    let activeSlideEl;
    const virtualEnabled = !!((_a = swiper.params.virtual) == null ? void 0 : _a.enabled);
...
var Thumb = ({ swiper, extendParams, on }) => {
  ...
  function onThumbClick() {
    ...
    if (thumbsSwiper.params.loop) {
      const attr = (_a = thumbsSwiper.clickedSlide) == null ? void 0 : _a.getAttribute("data-swiper-slide-index");
  ...
  function update(initial, p) {
    ...
    if (thumbsSwiper.params.loop || isVirtualEnabled4()) {
...
var Grid = ({ swiper, extendParams, on }) => {
  ...
  const initSlides = (slides) => {
    ...
    const slidesLength = isVirtualEnabled4() ? swiper.virtual.slides.length : slides.length;
...
var EffectCube = ({ swiper, extendParams, on }) => {
  ...
  const setTransition = (duration) => {
    ...
    if (((_a = swiper.params.cubeEffect) == null ? void 0 : _a.shadow) && !swiper.isHorizontal()) {
...
var EffectCards = ({ swiper, extendParams, on }) => {
  ...
  const setTranslate = () => {
    ...
    for (let i = 0; i < slides.length; i += 1) {
      ...
      const slideIndex = swiper.virtual && ((_a = swiper.params.virtual) == null ? void 0 : _a.enabled) ? swiper.virtual.from + i : i;

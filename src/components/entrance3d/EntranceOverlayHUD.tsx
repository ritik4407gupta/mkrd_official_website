    ...
    <div className="absolute inset-0 pointer-events-none z-30 flex flex-col justify-between p-4 sm:p-6 select-none">
      ...
      <div className="flex items-center justify-between w-full">
        ...
        <div className="pointer-events-auto flex items-center gap-3 bg-slate-950/80 backdrop-blur-md px-4 py-2 rounded-2xl border border-slate-700/80 shadow-2xl">
          ...
          <div>
            <div className="text-[10px] font-mono text-brand-400 font-bold uppercase tracking-wider">
              MKRD Virtual Engineering Lab
            </div>
            <div className="text-xs font-semibold text-slate-100 flex items-center gap-1.5">
              <span>Next-Gen R&D Facility</span>
              <span className="text-[10px] px-1.5 py-0.2 rounded bg-brand-950 text-brand-300 border border-brand-800 font-mono">
                LIVE 3D
              </span>
            </div>
          </div>
        ...
        <button
          ...
          onClick={onOpenDoors}
          disabled={isOpening}
          className="pointer-events-auto group flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-blue-600 via-brand-600 to-brand-500 hover:from-blue-500 hover:to-brand-400 text-white text-xs font-bold font-mono tracking-wider shadow-lg shadow-brand-500/25 transition-all transform hover:scale-105 active:scale-95 cursor-pointer"
        >
      ...
      {selectedStation && (
        <div className="pointer-events-auto self-center max-w-md w-full bg-slate-950/95 backdrop-blur-xl border border-brand-500/50 rounded-2xl p-5 shadow-[0_0_50px_rgba(124,113,255,0.3)] animate-in fade-in slide-in-from-bottom-6 duration-300">
          ...
          <div className="mt-3 flex items-center justify-between text-[11px] font-mono text-slate-400">
            ...
            <span className="text-brand-400">TOUCH 3D TO INTERACT</span>
          </div>
        </div>
      )}

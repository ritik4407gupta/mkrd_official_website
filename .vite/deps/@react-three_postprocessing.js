...
var $1193f60a44983e43$var$scale = (name) => {
  var _a2, _b2;
  const value = (_b2 = (_a2 = (0, $parcel$interopDefault($62561e92e160ec9a$exports)).quantization) == null ? void 0 : _a2.scales) == null ? void 0 : _b2[name];
  if (!(value > 0) || !Number.isFinite(value)) throw new Error(`The bundled N8AO neural model has no valid ${name} scale.`);
  return value;
};
var _a, _b, _c;
if ((0, $parcel$interopDefault($62561e92e160ec9a$exports)).architecture !== "attention-v3-int8" || (0, $parcel$interopDefault($62561e92e160ec9a$exports)).formatVersion !== 3 || ((_a = (0, $parcel$interopDefault($62561e92e160ec9a$exports)).quantization) == null ? void 0 : _a.scheme) !== "symmetric-int8-per-tensor" || ((_b = (0, $parcel$interopDefault($62561e92e160ec9a$exports)).quantization) == null ? void 0 : _b.zeroPoint) !== 0 || ((_c = (0, $parcel$interopDefault($62561e92e160ec9a$exports)).supportedDenoiseSamples) == null ? void 0 : _c.join(",")) !== "4,8,16" || $1193f60a44983e43$var$MATRIX_LAYOUTS.some(([, field, rows, columns]) => {
  var _a2;
  return ((_a2 = (0, $parcel$interopDefault($62561e92e160ec9a$exports))[field]) == null ? void 0 : _a2.length) !== rows * columns || (0, $parcel$interopDefault($62561e92e160ec9a$exports))[field].some((value) => !Number.isInteger(value) || value < -127 || value > 127);
...
var $1193f60a44983e43$var$tapInputBias = $1193f60a44983e43$var$foldedBias((0, $parcel$interopDefault($62561e92e160ec9a$exports)).tapInputWeights, (0, $parcel$interopDefault($62561e92e160ec9a$exports)).tapInputBias, (0, $parcel$interopDefault($62561e92e160ec9a$exports)).tapFeatureMean, (0, $parcel$interopDefault($62561e92e160ec9a$exports)).tapFeatureInverseStandardDeviation, 8, 9, $1193f60a44983e43$var$tapInputScale, {
  8: 1
});
...
var $1193f60a44983e43$var$tapInputRows = Array.from({
  length: 8
}, (_, row) => $1193f60a44983e43$var$quantizedRow((0, $parcel$interopDefault($62561e92e160ec9a$exports)).tapInputWeights, row, 9, $1193f60a44983e43$var$tapScaledAccessors, $1193f60a44983e43$var$tapInputScale, $1193f60a44983e43$var$tapInputBias));
var $1193f60a44983e43$var$tapInputShader = `
    NeuralToken neuralTapInput(NeuralToken raw) {
        NeuralToken scaledInput = NeuralToken(
            raw.lo * ${$1193f60a44983e43$var$vec4((0, $parcel$interopDefault($62561e92e160ec9a$exports)).tapFeatureInverseStandardDeviation.slice(0, 4), "            ")},
            raw.hi * ${$1193f60a44983e43$var$vec4((0, $parcel$interopDefault($62561e92e160ec9a$exports)).tapFeatureInverseStandardDeviation.slice(4, 8), "            ")}
        );
        return NeuralToken(
...
var $1193f60a44983e43$var$globalBias = $1193f60a44983e43$var$foldedBias((0, $parcel$interopDefault($62561e92e160ec9a$exports)).globalWeights, (0, $parcel$interopDefault($62561e92e160ec9a$exports)).globalBias, (0, $parcel$interopDefault($62561e92e160ec9a$exports)).globalFeatureMean, (0, $parcel$interopDefault($62561e92e160ec9a$exports)).globalFeatureInverseStandardDeviation, 8, 3, $1193f60a44983e43$var$globalScale);
...
var $1193f60a44983e43$var$globalRows = Array.from({
  length: 8
}, (_, row) => $1193f60a44983e43$var$quantizedRow((0, $parcel$interopDefault($62561e92e160ec9a$exports)).globalWeights, row, 3, $1193f60a44983e43$var$globalInputs, $1193f60a44983e43$var$globalScale, $1193f60a44983e43$var$globalBias));
var $1193f60a44983e43$var$globalInputShader = `
    NeuralToken neuralEncodeGlobal(vec4 raw) {
        vec3 scaledInput = raw.xyz * vec3(
            ${(0, $parcel$interopDefault($62561e92e160ec9a$exports)).globalFeatureInverseStandardDeviation.map($1193f60a44983e43$var$glslFloat).join(", ")}
        );
        return NeuralToken(
...
var $1193f60a44983e43$var$queryRows = Array.from({
  length: 4
}, (_, query) => $1193f60a44983e43$var$sumTerms($1193f60a44983e43$var$queryInputs.map((input, column) => $1193f60a44983e43$var$floatWeightedTerm((0, $parcel$interopDefault($62561e92e160ec9a$exports)).summaryQueries[query * 8 + column], input))));
...
var $1193f60a44983e43$var$headRows = Array.from({
  length: 8
}, (_, row) => $1193f60a44983e43$var$quantizedRow((0, $parcel$interopDefault($62561e92e160ec9a$exports)).headWeights, row, 32, $1193f60a44983e43$var$summaryInputs, $1193f60a44983e43$var$headScale, (0, $parcel$interopDefault($62561e92e160ec9a$exports)).headBias));
...
`;
var $1193f60a44983e43$var$outputExpression = $1193f60a44983e43$var$quantizedRow((0, $parcel$interopDefault($62561e92e160ec9a$exports)).outputWeights, 0, 8, $1193f60a44983e43$var$tokenAccessors("head"), $1193f60a44983e43$var$scale("outputWeight"), [
  (0, $parcel$interopDefault($62561e92e160ec9a$exports)).outputBias
]);
...
var $1193f60a44983e43$export$d75ad64dd346ec0e = [
  ...
  $1193f60a44983e43$var$tokenLayer({
    ...
    weights: (0, $parcel$interopDefault($62561e92e160ec9a$exports)).tapOutputWeights,
    bias: (0, $parcel$interopDefault($62561e92e160ec9a$exports)).tapOutputBias,
    relu: true
  }),
  ...
  $1193f60a44983e43$var$tokenLayer({
    ...
    scaleName: "keyWeight",
    weights: (0, $parcel$interopDefault($62561e92e160ec9a$exports)).keyProjectionWeights,
    bias: new Array(8).fill(0)
  }),
  $1193f60a44983e43$var$tokenLayer({
    functionName: "valueProject",
    scaleName: "valueWeight",
    weights: (0, $parcel$interopDefault($62561e92e160ec9a$exports)).valueProjectionWeights,
    bias: new Array(8).fill(0)
  }),
...
var $1193f60a44983e43$export$788ba311f03a5564 = $1193f60a44983e43$var$MATRIX_LAYOUTS.reduce((sum, [, field]) => sum + (0, $parcel$interopDefault($62561e92e160ec9a$exports))[field].length, 0);
var $1193f60a44983e43$export$dd4eb4d1095a3d82 = $1193f60a44983e43$var$MATRIX_LAYOUTS.reduce((sum, [, field]) => sum + (0, $parcel$interopDefault($62561e92e160ec9a$exports))[field].filter((value) => value !== 0).length, 0);
...
var $87431ee93b037844$export$2489f9981ab0fa82 = class extends (0, Pass) {
  ...
  configureDenoisePass(depthBufferType = (0, $05f6997e4b65da14$export$ed4ee5d1e55474a5).Default, ortho = false) {
    ...
    p2.fragmentShader = p2.fragmentShader.replace("__N8AO_DENOISE_SAMPLES__", this.configuration.denoiseSamples);
    ...
    this.standardDenoiseMaterial = new ShaderMaterial(p2);
    this.neuralDenoiseMaterial = this.configuration.neuralDenoise && [
      4,
      8,
      16
    ].includes(this.configuration.denoiseSamples) ? new ShaderMaterial({
      ...p2,
      glslVersion: GLSL3,
  ...
  render(renderer, inputBuffer, outputBuffer) {
    ...
    if (this.frame < 1024 / this.configuration.aoSamples) {
      ...
      for (let i2 = 0; i2 < this.configuration.denoiseIterations; i2++) {
        ...
        this.poissonBlurQuad.material = useNeuralDenoise && i2 === 1 ? this.neuralDenoiseMaterial : this.standardDenoiseMaterial;
...
function Selection({ children, enabled = true }) {
  ...
  return (0, import_jsx_runtime.jsx)(selectionContext.Provider, {
    value,
    children
  });
}
...
function Select({ enabled = false, children, ...props }) {
  ...
  const select = (_a2 = (0, import_react.use)(selectionContext)) == null ? void 0 : _a2.select;
  const claimed = (0, import_react.useRef)([]);
...
function updateIfChanged(ref, next) {
  ...
  if (next.length === previous.length && next.every((item, i2) => item === previous[i2])) return false;
  ref.current = next;
  return true;
}
function useSelectionSync(effect, selection, selectionLayer) {
  const invalidate = useThree((state) => state.invalidate);
  const api = (0, import_react.use)(selectionContext);
  (0, import_react.useEffect)(() => {
  ...
  (0, import_react.useEffect)(() => {
    var _a2;
    if (api && api.enabled && ((_a2 = api.selected) == null ? void 0 : _a2.length)) {
...
var useDispose = (instance) => {
  (0, import_react.useEffect)(() => {
    return () => {
      var _a2;
      (_a2 = instance == null ? void 0 : instance.dispose) == null ? void 0 : _a2.call(instance);
    };
  }, [instance]);
};
...
function useLiveDefaults(instance, values, keys, get2 = readPierced, set2 = applyPierced) {
  ...
  (0, import_react.useLayoutEffect)(() => {
    ...
    if (!resolved) return;
    if (((_a2 = snapshotRef.current) == null ? void 0 : _a2.instance) !== resolved) snapshotRef.current = {
      instance: resolved,
    ...
    for (const key of keys) {
      if (!defaults.has(key)) {
        const current = get2(resolved, key);
...
var autoClearGuard = createRendererPropertyGuard("autoClear");
var toneMappingGuard = createRendererPropertyGuard("toneMapping");
var glSize = new Vector2();
...
var EffectComposer2 = (0, import_react.memo)(function EffectComposer3({ children, camera: _camera2, scene: _scene, resolutionScale, enabled = true, renderPriority = 1, autoClear = true, autoRenderToScreen = true, depthBuffer, enableNormalPass, stencilBuffer, multisampling = 8, frameBufferType = HalfFloatType, renderPass = defaultRenderPass, mergeMode = "auto", ref }) {
  ...
  (0, import_react.useImperativeHandle)(ref, () => composerState == null ? void 0 : composerState.composer, [composerState]);
  if (!state) return null;
  return (0, import_jsx_runtime.jsx)(EffectComposerContext.Provider, {
    value: state,
...
function EffectGroup({ enabled = true, children, ref }) {
  const { camera, requestRebuild } = (0, import_react.use)(EffectComposerContext);
  const group = (0, import_react.useRef)(null);
  const effectsRef = (0, import_react.useRef)([]);
  ...
  (0, import_react.useImperativeHandle)(ref, () => pass, [pass]);
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsx)("group", {
    ref: group,
    children
  }), pass && (0, import_jsx_runtime.jsx)("primitive", { object: pass })] });
}
var i = 0;
...
function fingerprint(value, seen) {
  ...
  const out7 = {};
  for (const key of Object.keys(value).sort()) out7[key] = fingerprint(value[key], seen);
  return out7;
}
...
function wrapEffect(effect, defaults) {
  return function WrappedEffect({ ref, blendFunction = defaults == null ? void 0 : defaults.blendFunction, opacity = defaults == null ? void 0 : defaults.opacity, ...props }) {
    ...
    const camera = useThree((state) => state.camera);
    const args = (0, import_react.useMemo)(() => [...(defaults == null ? void 0 : defaults.args) ?? [], ...props.args ?? [{
      ...defaults,
      ...props
...
var ASCII = createEffectComponent(ASCIIEffect);
function DepthPicking({ ref }) {
  const { composer } = (0, import_react.use)(EffectComposerContext);
  ...
  useDispose(copyPass);
  (0, import_react.useImperativeHandle)(ref, () => ({ readDepth: (ndc) => depthPickingPass.readDepth(ndc) }), [depthPickingPass]);
  return null;
}
function useDepthPicking(pass, camera) {
  var _a2;
  const composerCamera = (_a2 = (0, import_react.use)(EffectComposerContext)) == null ? void 0 : _a2.camera;
  const defaultCamera = useThree((state) => state.camera);
  const resolvedCamera = camera ?? composerCamera ?? defaultCamera;
  const [ndc] = (0, import_react.useState)(() => new Vector3());
  return (0, import_react.useCallback)(async (x, y) => {
...
function set$3(effect, key, value) {
  if (key === "depthTexture") {
    const dt = value;
    effect.setDepthTexture(dt == null ? void 0 : dt.texture, dt == null ? void 0 : dt.packing);
...
function DepthOfField({ ref, blendFunction, worldFocusDistance, worldFocusRange, focusDistance, focusRange, focalLength, bokehScale, resolutionScale, resolutionX, resolutionY, width, height, target, depthTexture, ...props }) {
  const { camera } = (0, import_react.use)(EffectComposerContext);
  ...
  useDispose(effect);
  return (0, import_jsx_runtime.jsx)("primitive", {
    ...props,
    object: effect,
    ref,
    target
...
function Autofocus({ target = void 0, mouse: followMouse = false, debug = void 0, manual = false, smoothTime = 0.25, ref, ...props }) {
  const dofRef = (0, import_react.useRef)(null);
  const pickRef = (0, import_react.useRef)(null);
  const getHit = useDepthPicking(pickRef);
  const hitpointMarkerRef = (0, import_react.useRef)(null);
  const dofTargetMarkerRef = (0, import_react.useRef)(null);
  const scene = useThree(({ scene: scene2 }) => scene2);
  const pointer = useThree(({ pointer: pointer2 }) => pointer2);
  const [autoFocusMarker] = (0, import_react.useState)(() => new Vector3());
  const [hitpoint] = (0, import_react.useState)(() => new Vector3());
  const update = (0, import_react.useCallback)(async (delta, updateTarget = true) => {
    ...
    if (updateTarget && ((_a2 = dofRef.current) == null ? void 0 : _a2.target)) {
  ...
  useFrame((_, delta) => {
    ...
    if (dofTargetMarkerRef.current && ((_a2 = dofRef.current) == null ? void 0 : _a2.target)) dofTargetMarkerRef.current.position.copy(dofRef.current.target);
  });
  ...
  (0, import_react.useImperativeHandle)(ref, () => api, [api]);
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    (0, import_jsx_runtime.jsx)(DepthPicking, { ref: pickRef }),
    debug ? createPortal((0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsxs)("mesh", {
      ref: hitpointMarkerRef,
      children: [(0, import_jsx_runtime.jsx)("sphereGeometry", { args: [
        debug,
        16,
        16
      ] }), (0, import_jsx_runtime.jsx)("meshBasicMaterial", {
        color: "#00ff00",
        opacity: 1,
        transparent: true,
        depthWrite: false
      })]
    }), (0, import_jsx_runtime.jsxs)("mesh", {
    ...
    (0, import_jsx_runtime.jsx)(DepthOfField, {
      ref: dofRef,
      ...props,
...
var BloomImpl = createEffectComponent(BloomEffect);
function Bloom({ blendFunction = 0, luminanceThreshold, luminanceSmoothing, mipmapBlur, radius, levels, resolutionScale, resolutionX, resolutionY, ...liveProps }) {
  ...
  return (0, import_jsx_runtime.jsx)(BloomImpl, {
    blendFunction,
    args,
    ...liveProps
  });
}
var BrightnessContrast = createEffectComponent(BrightnessContrastEffect);
var ChromaticAberration = createEffectComponent(ChromaticAberrationEffect);
var ColorAverage = createEffectComponent(ColorAverageEffect);
var ColorDepthImpl = createEffectComponent(ColorDepthEffect);
function ColorDepth({ bits, ...props }) {
  if (bits !== void 0) props.bitDepth = bits;
  return (0, import_jsx_runtime.jsx)(ColorDepthImpl, { ...props });
}
var Depth = createEffectComponent(DepthEffect);
var DotScreen = createEffectComponent(DotScreenEffect);
var FXAA = createEffectComponent(FXAAEffect);
var GlitchImpl = createEffectComponent(GlitchEffect);
function Glitch({ active = true, mode = GlitchMode.SPORADIC, dtSize, ...props }) {
  const args = (0, import_react.useMemo)(() => [{ dtSize }], [dtSize]);
  return (0, import_jsx_runtime.jsx)(GlitchImpl, {
    args,
...
function GodRays({ sun, blendFunction, density, decay, weight, exposure, clampMax, blur, kernelSize, samples, width, height, resolutionScale, resolutionX, resolutionY, ref }) {
  const { camera, autoClear } = (0, import_react.use)(EffectComposerContext);
  const invalidate = useThree((state) => state.invalidate);
  const effect = (0, import_react.useMemo)(() => new GodRaysEffect(camera, resolveRef(sun), {
    resolutionScale,
    resolutionX,
    resolutionY
  }), [
...
var GridImpl = createEffectComponent(GridEffect);
function Grid({ size, ref, ...props }) {
  const invalidate = useThree((state) => state.invalidate);
  const localRef = (0, import_react.useRef)(null);
  (0, import_react.useImperativeHandle)(ref, () => localRef.current, []);
  (0, import_react.useLayoutEffect)(() => {
    var _a2;
    if (size) {
      (_a2 = localRef.current) == null ? void 0 : _a2.setSize(size.width, size.height);
      invalidate();
    }
  }, [size, invalidate]);
  return (0, import_jsx_runtime.jsx)(GridImpl, {
    ref: localRef,
    ...props
  });
}
var HueSaturation = createEffectComponent(HueSaturationEffect);
...
var LensFlareWrapped = createEffectComponent(LensFlareEffect);
var DEFAULT_SCREEN_RES = new Vector2(0, 0);
var DEFAULT_LENS_POSITION = new Vector3(-25, 6, -60);
var LensFlare = (props) => {
  const { ref: forwardedRef, smoothTime = 0.07, blendFunction = 23, enabled = true, glareSize = 0.2, screenRes, starPoints = 6, flareSize = 0.01, flareSpeed = 0.01, flareShape = 0.01, animated = true, anamorphic = false, colorGain = new Color(20, 20, 20), lensDirtTexture = null, haloScale = 0.5, secondaryGhosts = true, aditionalStreaks = true, ghostScale = 0, opacity = 1, starBurst = false } = props;
  ...
  const [raycasterPos] = (0, import_react.useState)(() => new Vector2());
  const [projectedPosition] = (0, import_react.useState)(() => new Vector3());
  ...
  useFrame((_, delta) => {
    ...
    if (object) {
      target = 1;
      if (((_a2 = object.userData) == null ? void 0 : _a2.lensflare) === "no-occlusion") target = 0;
      else if (object instanceof Mesh) {
        if (((_c2 = (_b2 = object.material.uniforms) == null ? void 0 : _b2._transmission) == null ? void 0 : _c2.value) > 0.2) target = 0.2;
        else if (object.material._transmission && object.material._transmission > 0.2) target = 0.2;
  ...
  return (0, import_jsx_runtime.jsx)(LensFlareWrapped, {
    ref: setRef,
    blendFunction,
    enabled,
    glareSize,
...
function LUT({ lut, blendFunction, tetrahedralInterpolation, ref }) {
  const effect = (0, import_react.useMemo)(() => new LUT3DEffect(lut), []);
  useLiveDefaults(effect, {
    "blendMode-blendFunction": blendFunction,
    lut,
    tetrahedralInterpolation
...
var NoiseImpl = createEffectComponent(NoiseEffect);
function Noise({ blendFunction = 5, ...props }) {
  return (0, import_jsx_runtime.jsx)(NoiseImpl, {
    blendFunction,
    ...props
  });
}
...
function Outline({ selection = EMPTY_ARRAY, selectionLayer = 10, blendFunction, resolutionScale, resolutionX, resolutionY, ref, ...liveProps }) {
  const { scene, camera, autoClear } = (0, import_react.use)(EffectComposerContext);
...
var PixelationImpl = createEffectComponent(PixelationEffect);
function Pixelation({ granularity = 5, ref }) {
  return (0, import_jsx_runtime.jsx)(PixelationImpl, {
    granularity,
    ref
  });
}
var RampShader = { fragmentShader: `
  ...
  ` };
var RampType = (function(RampType2) {
...
var RampEffect = class extends Effect {
  constructor({ rampType = 0, rampStart = [0.5, 0.5], rampEnd = [1, 1], startColor = [
    0,
    0,
    0,
    1
    ...
    1,
    1
  ], rampBias = 0.5, rampGain = 0.5, rampMask = false, rampInvert = false, ...params } = {}) {
...
var Ramp = createEffectComponent(RampEffect);
var Scanline = createEffectComponent(ScanlineEffect);
...
function SelectiveBloom({ selection = EMPTY_ARRAY, selectionLayer = 10, lights = EMPTY_ARRAY, luminanceThreshold, luminanceSmoothing, mipmapBlur, radius, levels, resolutionScale, resolutionX, resolutionY, ref, ...liveProps }) {
  const { scene, camera } = (0, import_react.use)(EffectComposerContext);
  const invalidate = useThree((state) => state.invalidate);
...
var Sepia = createEffectComponent(SepiaEffect);
var LIVE_KEYS$1 = [
  "position",
  "speed",
  "maxRadius",
...
function ShockWave(props) {
  ...
  const { camera } = (0, import_react.use)(EffectComposerContext);
  const effect = (0, import_react.useMemo)(() => new ShockWaveEffect(camera), [camera]);
  useLiveDefaults(effect, {
...
var SMAAImpl = createEffectComponent(SMAAEffect);
function SMAA({ preset, edgeDetectionMode, predicationMode, ...liveProps }) {
  ...
  return (0, import_jsx_runtime.jsx)(SMAAImpl, {
    args,
    ...liveProps
  });
}
...
function SSAO({ blendFunction = 21, samples = 30, rings = 4, distanceThreshold = 1, distanceFalloff = 0, rangeThreshold = 0.5, rangeFalloff = 0.1, luminanceInfluence = 0.9, radius = 20, bias = 0.5, intensity = 1, color, worldDistanceThreshold, worldDistanceFalloff, worldProximityThreshold, worldProximityFalloff, minRadiusScale, fade: fade2, depthAwareUpsampling = true, resolutionScale, resolutionX, resolutionY, width, height, ref }) {
  const { camera, normalPass, downSamplingPass, resolutionScale: composerResolutionScale } = (0, import_react.use)(EffectComposerContext);
  const effect = (0, import_react.useMemo)(() => {
...
var TextureImpl = createEffectComponent(TextureEffect);
function Texture2({ textureSrc, texture, opacity = 1, ...props }) {
  const t = useLoader(TextureLoader, textureSrc);
  (0, import_react.useLayoutEffect)(() => {
    t.colorSpace = SRGBColorSpace;
    t.wrapS = t.wrapT = RepeatWrapping;
  }, [t]);
  return (0, import_jsx_runtime.jsx)(TextureImpl, {
    ...props,
    texture: texture ?? t,
    opacity
  });
}
var TiltShiftImpl = createEffectComponent(TiltShiftEffect);
function TiltShift({ blendFunction = 0, kernelSize, resolutionScale, resolutionX, resolutionY, ...liveProps }) {
  ...
  return (0, import_jsx_runtime.jsx)(TiltShiftImpl, {
    blendFunction,
    args,
    ...liveProps
  });
...
var TiltShiftEffect2 = class extends Effect {
  constructor({ blendFunction = 23, blur = 0.15, taper = 0.5, start = [0.5, 0], end = [0.5, 1], samples = 10, direction = [1, 1] } = {}) {
...
var TiltShift2 = createEffectComponent(TiltShiftEffect2);
var ToneMappingImpl = createEffectComponent(ToneMappingEffect);
function ToneMapping({ minLuminance, maxLuminance, ...liveProps }) {
  const args = (0, import_react.useMemo)(() => [{
    minLuminance,
    maxLuminance
  }], [minLuminance, maxLuminance]);
  return (0, import_jsx_runtime.jsx)(ToneMappingImpl, {
    args,
    ...liveProps
  });
}
var Vignette = createEffectComponent(VignetteEffect);
...
var WaterEffect = createEffectComponent(WaterEffectImpl);
function N8AO({ enabled = true, halfRes, screenSpaceRadius, quality, depthAwareUpsampling = true, aoRadius = 5, aoSamples = 16, denoiseSamples = 4, denoiseRadius = 12, distanceFalloff = 1, intensity = 1, color, renderMode = 0, ref }) {
  ...
  const effect = (0, import_react.useMemo)(() => {
    const instance = new $87431ee93b037844$export$2489f9981ab0fa82(scene, camera);
